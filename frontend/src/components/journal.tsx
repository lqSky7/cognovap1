    ...
    const mockEntries: JournalEntry[] = [
      {
        entry_id: "1",
        title: "A Great Day!",
        content: "Today was amazing! I felt really productive and accomplished a lot of my goals. The weather was beautiful and I had a great conversation with a friend. I'm feeling grateful for all the positive things in my life right now.",
        mood_score: 8,
      ...
      },
      {
        ...
        content: "I've been thinking about how much I've grown over the past year. There have been challenges, but each one has taught me something valuable. I'm learning to be more patient with myself and to celebrate small victories.",
        mood_score: 7,
      ...
      },
      {
        ...
        content: "Work has been really stressful lately and I'm feeling a bit overwhelmed. I know this is temporary, but it's hard to see the light at the end of the tunnel sometimes. I need to remember to take breaks and practice self-care.",
        mood_score: 4,
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => setNewEntry(prev => ({ ...prev, mood_score: parseInt(e.target.value) || 5 }))}
                  />
                </div>
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => setNewEntry(prev => ({ ...prev, accessible_in_chat: e.target.checked }))}
                  className="rounded"
                />
